...
<?php if(!isset($permissions_result) || (isset($permissions_result) && $permissions_result == false)): ?>
    ...
    <?php if ($language_combined_result == true): ?>
        ...
        <div class="folder-permission-result incorrect">
            ...
            Language permissions are incorrect. Please make sure to apply the permissions for this folder recursively.
            This means all existing sub folders and files in the language directory need to have permissions of 777 as
            well.


            <?php if ($language_folder_result != true): ?>
            <br><br><strong>The permissions on duet/server/application/language/ are incorrect. This folder should be
                777</strong>
            <?php endif; ?>

            <?php if ($build_folder_result != true): ?>
            <br><br><strong>The permissions on duet/server/application/language/en/build/ are incorrect. This folder
                should be 777</strong>
            <?php endif; ?>

            <?php if ($build_file_result != true): ?>
            <br><br><strong>The permissions on duet/server/application/language/en/build/all.php are incorrect. This
                file should be 777</strong>
            <?php endif; ?>
    ...
    <p>
        ...
        change the permissions on the four folders highlighted in blue. Permissions should be set to 777</strong><br>
        <br>
